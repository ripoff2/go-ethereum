...
func TestTypeRegexp(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"bool[][]", nil, Type{
				T: SliceTy, Elem: &Type{T: SliceTy, Elem: &Type{T: BoolTy, stringKind: "bool"}, stringKind: "bool[]"},
				stringKind: "bool[][]",
			},
		},
		{
		...
		{
			"int8[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 8, T: IntTy, stringKind: "int8"}, stringKind: "int8[2]"},
		},
		{"int16[]", nil, Type{T: SliceTy, Elem: &Type{Size: 16, T: IntTy, stringKind: "int16"}, stringKind: "int16[]"}},
		{
			"int16[2]", nil,
			Type{Size: 2, T: ArrayTy, Elem: &Type{Size: 16, T: IntTy, stringKind: "int16"}, stringKind: "int16[2]"},
		},
		{"int32[]", nil, Type{T: SliceTy, Elem: &Type{Size: 32, T: IntTy, stringKind: "int32"}, stringKind: "int32[]"}},
		{
			"int32[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 32, T: IntTy, stringKind: "int32"}, stringKind: "int32[2]"},
		},
		{"int64[]", nil, Type{T: SliceTy, Elem: &Type{Size: 64, T: IntTy, stringKind: "int64"}, stringKind: "int64[]"}},
		{
			"int64[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 64, T: IntTy, stringKind: "int64"}, stringKind: "int64[2]"},
		},
		{
			"int256[]", nil,
			Type{T: SliceTy, Elem: &Type{Size: 256, T: IntTy, stringKind: "int256"}, stringKind: "int256[]"},
		},
		{
			"int256[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 256, T: IntTy, stringKind: "int256"}, stringKind: "int256[2]"},
		},
		...
		{
			"uint8[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 8, T: UintTy, stringKind: "uint8"}, stringKind: "uint8[2]"},
		},
		{
			"uint16[]", nil,
			Type{T: SliceTy, Elem: &Type{Size: 16, T: UintTy, stringKind: "uint16"}, stringKind: "uint16[]"},
		},
		{
			"uint16[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 16, T: UintTy, stringKind: "uint16"}, stringKind: "uint16[2]"},
		},
		{
			"uint32[]", nil,
			Type{T: SliceTy, Elem: &Type{Size: 32, T: UintTy, stringKind: "uint32"}, stringKind: "uint32[]"},
		},
		{
			"uint32[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 32, T: UintTy, stringKind: "uint32"}, stringKind: "uint32[2]"},
		},
		{
			"uint64[]", nil,
			Type{T: SliceTy, Elem: &Type{Size: 64, T: UintTy, stringKind: "uint64"}, stringKind: "uint64[]"},
		},
		{
			"uint64[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{Size: 64, T: UintTy, stringKind: "uint64"}, stringKind: "uint64[2]"},
		},
		{
			"uint256[]", nil,
			Type{T: SliceTy, Elem: &Type{Size: 256, T: UintTy, stringKind: "uint256"}, stringKind: "uint256[]"},
		},
		{
			"uint256[2]", nil, Type{
				T: ArrayTy, Size: 2, Elem: &Type{Size: 256, T: UintTy, stringKind: "uint256"}, stringKind: "uint256[2]",
			},
		},
		...
		{
			"bytes[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{T: BytesTy, stringKind: "bytes"}, stringKind: "bytes[2]"},
		},
		{
			"bytes32[]", nil,
			Type{T: SliceTy, Elem: &Type{T: FixedBytesTy, Size: 32, stringKind: "bytes32"}, stringKind: "bytes32[]"},
		},
		{
			"bytes32[2]", nil, Type{
				T: ArrayTy, Size: 2, Elem: &Type{T: FixedBytesTy, Size: 32, stringKind: "bytes32"}, stringKind: "bytes32[2]",
			},
		},
		...
		{
			"string[2]", nil,
			Type{T: ArrayTy, Size: 2, Elem: &Type{T: StringTy, stringKind: "string"}, stringKind: "string[2]"},
		},
		{"address", nil, Type{Size: 20, T: AddressTy, stringKind: "address"}},
		{
			"address[]", nil,
			Type{T: SliceTy, Elem: &Type{Size: 20, T: AddressTy, stringKind: "address"}, stringKind: "address[]"},
		},
		{
			"address[2]", nil, Type{
				T: ArrayTy, Size: 2, Elem: &Type{Size: 20, T: AddressTy, stringKind: "address"}, stringKind: "address[2]",
			},
		},
		...
		// {"fixed128x128[2]", nil, Type{}},
		{
			"tuple", []ArgumentMarshaling{{Name: "a", Type: "int64"}}, Type{
				T: TupleTy, TupleType: reflect.TypeOf(
					struct {
						A int64 `json:"a"`
					}{},
				), stringKind: "(int64)",
	...
	for _, tt := range tests {
		...
		if !reflect.DeepEqual(typ, tt.kind) {
			t.Errorf(
				"type %q: parsed type mismatch:\nGOT %s\nWANT %s ", tt.blob, spew.Sdump(typeWithoutStringer(typ)),
...
func TestInternalType(t *testing.T) {
	...
	if !reflect.DeepEqual(typ, kind) {
		t.Errorf(
			"type %q: parsed type mismatch:\nGOT %s\nWANT %s ", blob, spew.Sdump(typeWithoutStringer(typ)),
			spew.Sdump(typeWithoutStringer(kind)),
		)
	}
}
	...
	var testCases = []struct {
		...
		// tuple tuple
		{
			"tuple", []ArgumentMarshaling{
				{
					Name: "x", Type: "tuple", Components: []ArgumentMarshaling{{Name: "x", Type: "bytes32"}},
				},
			}, 32,
		},
		{
			"tuple", []ArgumentMarshaling{
				{
					Name: "x", Type: "tuple",
					Components: []ArgumentMarshaling{{Name: "x", Type: "bytes32[2]"}, {Name: "y", Type: "uint256"}},
				},
			}, 32 * (2 + 1),
		},
	}
