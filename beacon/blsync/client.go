...
import (
	...
	"github.com/ripoff2/go-ethereum/beacon/light/api"
...
func NewClient(ctx *cli.Context) *Client {
	...
	var (
		...
		committeeChain = light.NewCommitteeChain(
			db, chainConfig.ChainConfig, threshold, !ctx.Bool(utils.BeaconNoFilterFlag.Name),
		)
