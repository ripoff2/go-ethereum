...
// See https://github.com/ripoff2/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState, baseFee *big.Int) (*core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/ripoff2/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
