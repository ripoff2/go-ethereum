...
func TestGetBlockHeadersDataEncodeDecode(t *testing.T) {
	...
	tests := []struct {
		...
		{
			fail:   false,
			packet: &GetBlockHeadersRequest{Origin: HashOrNumber{Number: 314}, Amount: 314, Skip: 1, Reverse: true},
		},
		{
			fail:   false,
			packet: &GetBlockHeadersRequest{Origin: HashOrNumber{Hash: hash}, Amount: 314, Skip: 1, Reverse: true},
		},
